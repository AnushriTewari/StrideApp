...
import { TeamPage } from '.././actions/listUserAction';
...
class Team extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.Reducers.team_data) {
            console.log(nextProps.Reducers.team_data)
        }
    }
    _keyExtractor = (item, index) => index;

    render() {
        if (this.props.Reducers.team_data) {
            const teamData = this.props.Reducers.team_data
            return (
