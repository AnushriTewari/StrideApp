...
import { donationPage } from '.././actions/listUserAction';
...
class Donation extends Component {
    ...
    componentWillReceiveProps(nextProps){
        if(nextProps.Reducers.donation_data)
        {
    ...
    render() {
        if(this.props.Reducers.donation_data){
            const donationData = this.props.Reducers.donation_data
        return (
